...
const StudHome = () => {
  ...
  const menus = [
    ...
    { name: "Course Registration", link: "/", icon: PiStudentFill },
    { name: "Courses", link: "/", icon: SiGoogleclassroom },
    { name: "Academic Records", link: "/", icon: LiaUserEditSolid },
    { name: "Statistics", link: "/", icon: ImStatsDots },
    { name: "Settings", link: "/", icon: IoMdSettings },
    { name: "e-Resources", link: "/", icon: GrResources },
